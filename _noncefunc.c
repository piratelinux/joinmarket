...
/*  0 */ _CFFI_OP(_CFFI_OP_FUNCTION, 8), // int()(unsigned char *, unsigned char const *, unsigned char const *, unsigned char const *, void *, unsigned int)
/*  1 */ _CFFI_OP(_CFFI_OP_POINTER, 9), // unsigned char *
/*  2 */ _CFFI_OP(_CFFI_OP_POINTER, 9), // unsigned char const *
/*  3 */ _CFFI_OP(_CFFI_OP_NOOP, 2),
/*  4 */ _CFFI_OP(_CFFI_OP_NOOP, 2),
/*  5 */ _CFFI_OP(_CFFI_OP_POINTER, 10), // void *
...
static int _cffi_d_nonce_function_rand(unsigned char * x0, unsigned char const * x1, unsigned char const * x2, unsigned char const * x3, void * x4, unsigned int x5)
{
  return nonce_function_rand(x0, x1, x2, x3, x4, x5);
}
#ifndef PYPY_VERSION
static PyObject *
_cffi_f_nonce_function_rand(PyObject *self, PyObject *args)
{
  unsigned char * x0;
  ...
  aa = _cffi_unpack_args(args, 6, "nonce_function_rand");
  if (aa == NULL)
    return NULL;
  arg0 = aa[0];
  arg1 = aa[1];
  ...
  _cffi_restore_errno();
  { result = nonce_function_rand(x0, x1, x2, x3, x4, x5); }
  _cffi_save_errno();
...
#else
#  define _cffi_f_nonce_function_rand _cffi_d_nonce_function_rand
#endif

static const struct _cffi_global_s _cffi_globals[] = {
  { "nonce_function_rand", (void *)_cffi_f_nonce_function_rand, _CFFI_OP(_CFFI_OP_CPYTHON_BLTN_V, 0), (void *)_cffi_d_nonce_function_rand },
};
...
#ifdef PYPY_VERSION
PyMODINIT_FUNC
_cffi_pypyinit__noncefunc(const void *p[])
{
...
#  ifdef _MSC_VER
     PyMODINIT_FUNC
#  if PY_MAJOR_VERSION >= 3
     PyInit__noncefunc(void) { return NULL; }
#  else
     init_noncefunc(void) { }
#  endif
#  endif
...
PyMODINIT_FUNC
PyInit__noncefunc(void)
{
  return _cffi_init("_noncefunc", 0x2601, &_cffi_type_context);
}
#else
PyMODINIT_FUNC
init_noncefunc(void)
{
  _cffi_init("_noncefunc", 0x2601, &_cffi_type_context);
}
#endif
